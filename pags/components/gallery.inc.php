<section class="gallery">
      ...
      <div class="container">
        ...
        <div class="row my-3 g-3">
          <div class="col-md-4">
            <img src="/educa_juntos/img/c1.jpg" alt="Gallery image" class="img-fluid" />
          </div>
          <div class="col-md-4">
            <img src="/educa_juntos/img/c2.jpg" alt="Gallery image" class="img-fluid" />
          </div>
          <div class="col-md-4">
            <img src="/educa_juntos/img/c3.jpg" alt="Gallery image" class="img-fluid" />
          </div>
        </div>
