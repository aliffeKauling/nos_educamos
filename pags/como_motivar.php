...
<h1 class="text-center">Como motivar as crianças na hora da tarefa?</h1>
...
<section class="services gradient ">
  ...
  <div class="container">
    ...
    <div class="row align-items-center justify-content-center">
      <div class="col-md-5">
        <h1>Lucia do Carmo</h1>

        <p>
          Olá, sou fonoaudióloga. Comece a ler histórias para ela, será um grande passo. Quando a criança escuta alguém lendo histórias,
          aumenta o vocabulário dela e ela começa a entrar no mundo da leitura e escrita. Acho que esse é um grande passo para a alfabetização.
          No meu instagram (@bela_fono) tem um vídeo no qual dou dicas de estratégias para ler histórias para crianças entre 4 e 6 anos de idade,
          dê uma olhada caso você não saiba como começar.
        </p>

        <a href='https://www.instagram.com/tv/CNBFn3SpX6z/...'><button type="button" class="btn btn-outline-warning mb-3">
            Ver mais
          </button></a>
      </div>
      <div class="col-md-5"><img src="components/img/2.svg" alt="" /></div>
    </div>
  </div>
...
<div class="container">
  ...
  <div class="row align-items-center justify-content-center">
    <div class="col-md-5">
      <?php
      $link = mysqli_connect("localhost", "root", "", "educa");
      $query = "SELECT nome, depoimento, imagem FROM depoimento WHERE pagina = 'como_motivar' ORDER BY nome";
      $result = mysqli_query($link, $query);
      ...
      <div class="col-md-5">
        <form method="post" action="proc_cad_img.php" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="nome" placeholder="Maria Aparecida" />
          </div>
          <div class="mb-3">
            <label for="exampleFormControlTextarea1" class="form-label">Conte algo para nós:</label>
            <textarea class="form-control" name="depoimento" rows="3"></textarea>
          </div>
          <div class="mb-3">
            <label for="exampleFormControlTextarea1" class="form-label">Foto:
            </label>
            <input type="file" name="imagem" />
          </div>
          <p></p>
          <input type="hidden" name="pagina" value="como_motivar"></input>
          </input>
